  ...
  resultsSnapshot: [
    {
      ...
      bullets: [
        "Push CTR lift: 0.7% -> 2-3%",
        "Hooks, timing, and tone A/B testing",
        "Push, WhatsApp, SMS content systems",
      ],
    },
    {
    ...
    },
    {
      ...
      bullets: [
        "Content pillars + calendars for creators",
        "Campaign alignment + copy direction",
        "Proof samples available on request",
      ],
    },
    {
      title: "Tools",
      bullets: [
        "AI tools for content creation + optimization",
        "Content calendars + collaboration systems",
        "Analytics-informed copy iterations",
      ],
    },
  ],
  skills: [
